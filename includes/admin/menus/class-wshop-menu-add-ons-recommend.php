    ...
    public function admin_options(){
        ...
        <div class="wrap plugin-install-tab-featured">
        	...
        	<ul class="filter-links">
    			<li class="plugin-install-featured"><a href="<?php echo admin_url('admin.php?page=shop_page_add_ons&section=menu_add_ons_recommend&tab=settings_add_ons_recommend_plugins')?>" class="<?php echo ($category_id==0?'current':'')?>"><?php echo __('All',WSHOP)?></a> </li>
            	<li class="plugin-install-popular"><a href="<?php echo admin_url('admin.php?page=shop_page_add_ons&section=menu_add_ons_recommend&tab=settings_add_ons_recommend_plugins&cid=14')?>" class="<?php echo ($category_id==14?'current':'')?>"><?php echo __('WooCommerce',WSHOP)?></a> </li>
            	<li class="plugin-install-recommended"><a href="<?php echo admin_url('admin.php?page=shop_page_add_ons&section=menu_add_ons_recommend&tab=settings_add_ons_recommend_plugins&cid=15')?>" class="<?php echo ($category_id==15?'current':'')?>"><?php echo __('Wordpress',WSHOP)?></a> </li>
            	<li class="plugin-install-favorites"><a href="<?php echo admin_url('admin.php?page=shop_page_add_ons&section=menu_add_ons_recommend&tab=settings_add_ons_recommend_plugins&cid=20')?>" class="<?php echo ($category_id==20?'current':'')?>"><?php echo __('Easy Digital Downloads',WSHOP)?></a></li>
            	<li class="plugin-install-favorites"><a href="<?php echo admin_url('admin.php?page=shop_page_add_ons&section=menu_add_ons_recommend&tab=settings_add_ons_recommend_plugins&cid=21')?>" class="<?php echo ($category_id==21?'current':'')?>"><?php echo __('Magento',WSHOP)?></a></li>
            	<li class="plugin-install-favorites"><a href="<?php echo admin_url('admin.php?page=shop_page_add_ons&section=menu_add_ons_recommend&tab=settings_add_ons_recommend_plugins&cid=22')?>" class="<?php echo ($category_id==22?'current':'')?>"><?php echo __('Avoid signing/Personal payments',WSHOP)?></a></li>
            	<li class="plugin-install-favorites"><a href="<?php echo admin_url('admin.php?page=shop_page_add_ons&section=menu_add_ons_recommend&tab=settings_add_ons_recommend_plugins&cid=23')?>" class="<?php echo ($category_id==23?'current':'')?>"><?php echo __('Other',WSHOP)?></a></li>
        	</ul>
